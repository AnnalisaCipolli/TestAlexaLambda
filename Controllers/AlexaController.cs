...
namespace AlexaGitHubDemo.Controllers
{
    ...
    public class AlexaController : Controller
    {
        ...
        public const string owner = "AnnalisaCipolli";
        public const string repo = "leo001";
        public const string product_name = "AlexaGitHubDemo";
        public const string token = " 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 ";
        const string ITA_Locale = "it-IT";
        ...
        private void ProcessLaunchRequest(FactData factdata, ResponseBody response)
        {
            if (factdata != null)
            {
                ...
                prompt.Text = factdata.LaunchMessageReprompt;
                prompt.Type = "PlainText";
            ...
            switch (intentRequest.Intent.Name)
            {
                case "GetWeather":
                    ...
                    if (!string.IsNullOrEmpty(speech_message))
                    {
                        ...
                        (response.Response.OutputSpeech as SsmlOutputSpeech).Type = "SSML";
        ...
        private IOutputSpeech ProcessIntentRequest(FactData factdata, SkillRequest input)
        {
            ...
            switch (intentRequest.Intent.Name)
            {
                ...
                case AlexaConstants.CancelIntent:
                    ...
                    (innerResponse as PlainTextOutputSpeech).Type = "PlainText";
